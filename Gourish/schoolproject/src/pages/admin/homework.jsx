...
const Homeworkreports = () => {
  ...
  return (
    <div className="min-h-screen p-6 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-white transition-colors duration-300">
      {/* Page Header */}
      <h2 className="text-2xl font-bold mb-6 text-center">Student Reports</h2>
