...
const AdmitCardPage = () => {
  ...
  const [admitCards, setAdmitCards] = useState([
    { id: 1, name: "Sample marks sheet", image: "broken" },
  ...
  return (
    <div className="flex h-screen h-full bg-white">
      {/* Left Section (Add Admit Card Form) */}
      <div className="flex-grow p-6 bg-white shadow-md rounded-lg mr-1 ml-3 mt-3 min-h-[350vh]">
        <h2 className="text-2xl font-bold mb-6">Add Marksheet</h2>
      ...
      {/* Right Section (Admit Card List) */}
      <div className="flex-grow p-6 bg-white shadow-md rounded-lg overflow-y-auto mr-3 ml-3 mt-3 h-[350%]">
        <h2 className="text-2xl font-semibold mb-4">Marksheet List</h2>
        ...
        {/* Modal for Viewing Marks Card Details */}
{isModalOpen && (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-50">
    <div className="bg-white rounded-lg shadow-lg p-6 w-2/3 max-h-screen overflow-y-auto">
      <h2 className="text-2xl font-bold mb-4">View Marks Card</h2>
      <p><strong>School Name:</strong> ST Teresa School</p>
      <p><strong>Student Name:</strong> {selectedAdmitCard?.name}</p>
      <p><strong>Roll Number:</strong> {formData.rollNo || "N/A"}</p>
      <p><strong>Class & Section:</strong> {formData.classSection || "N/A"}</p>
      <table className="w-full text-left border-collapse mt-4">
        <thead className="bg-gray-200">
          <tr>
            <th className="py-3 px-4 font-medium text-gray-700">Subject</th>
            <th className="py-3 px-4 font-medium text-gray-700">Maximum Marks</th>
            <th className="py-3 px-4 font-medium text-gray-700">Marks Obtained</th>
            <th className="py-3 px-4 font-medium text-gray-700">Grade</th>
          </tr>
        </thead>
        <tbody>
          <tr>
